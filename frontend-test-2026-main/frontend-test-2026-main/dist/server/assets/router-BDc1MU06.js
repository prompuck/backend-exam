...
const appCss = "/assets/styles-BULJTr5A.css";
...
function AppSidebar({ ...props }) {
  return /* @__PURE__ */ jsxs(Sidebar, { ...props, children: [
    /* @__PURE__ */ jsx(SidebarHeader, { children: /* @__PURE__ */ jsx(SidebarMenu, { children: /* @__PURE__ */ jsx(SidebarMenuItem, { children: /* @__PURE__ */ jsx(SidebarMenuButton, { size: "lg", asChild: true, children: /* @__PURE__ */ jsxs("a", { href: "/", children: [
      /* @__PURE__ */ jsx("div", { className: "flex aspect-square size-8 items-center justify-center rounded-lg bg-sidebar-primary text-sidebar-primary-foreground", children: /* @__PURE__ */ jsx("img", { src: "/swd-logo.png", alt: "SWD Logo", className: "size-8" }) }),
      /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-0.5 leading-none", children: [
        /* @__PURE__ */ jsx("span", { className: "font-medium", children: "SWD - Frontend Test" }),
        /* @__PURE__ */ jsx("span", { className: "", children: "Version 2026" })
      ] })
    ] }) }) }) }) }),
    /* @__PURE__ */ jsx(SidebarContent, { children: /* @__PURE__ */ jsx(SidebarGroup, { children: /* @__PURE__ */ jsx(SidebarMenu, { children: data.navMain.map((item) => /* @__PURE__ */ jsxs(SidebarMenuItem, { children: [
      ...
      item.items.length ? /* @__PURE__ */ jsx(SidebarMenuSub, { children: item.items.map((subItem) => /* @__PURE__ */ jsx(SidebarMenuSubItem, { children: /* @__PURE__ */ jsx(SidebarMenuSubButton, { asChild: true, children: /* @__PURE__ */ jsx(Link, { to: subItem.url, children: subItem.title }) }) }, subItem.title)) }) : null
    ] }, item.title)) }) }) }),
...
function Layout({ children }) {
  return /* @__PURE__ */ jsxs(SidebarProvider, { children: [
    ...
    /* @__PURE__ */ jsxs(SidebarInset, { children: [
      /* @__PURE__ */ jsx("header", { className: "flex h-16 shrink-0 items-center gap-2 border-b", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 px-3", children: [
        /* @__PURE__ */ jsx(SidebarTrigger, {}),
        /* @__PURE__ */ jsx(Separator, { orientation: "vertical", className: "mr-2 h-4" }),
        /* @__PURE__ */ jsx(ThemeToggle, {})
      ] }) }),
      /* @__PURE__ */ jsx("div", { className: "flex flex-1 flex-col gap-4 p-4", children }),
      /* @__PURE__ */ jsx("footer", { className: "px-4 pb-4 text-center text-muted-foreground text-sm", children: /* @__PURE__ */ jsx("p", { children: "© 2026 Frontend Developer Challenge" }) })
    ] })
  ] });
}
...
const $$splitComponentImporter$1 = () => import("./index-TCcJDM3F.js");
const Route$1 = createFileRoute("/")({
  component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
const $$splitComponentImporter = () => import("./code-challenge.feature-flag-form-BzzBV3qo.js");
const Route = createFileRoute("/code-challenge/feature-flag-form")({
...
const CodeChallengeFeatureFlagFormRoute = Route.update({
...
const rootRouteChildren = {
  IndexRoute,
  CodeChallengeFeatureFlagFormRoute
};
