...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./assets/_tanstack-start-manifest_v-RKspAKD6.js");
...
async function loadEntries() {
  const routerEntry = await import("./assets/router-BDc1MU06.js").then((n2) => n2.r);
  return {
